...
def test_direct_top1_graph_replay_falls_back_before_graph_lookup():
    ...
    assert not DecodeCudaGraphRunner.can_run_graph(runner, _batch(is_all_greedy=False))
...
def test_empty_lm_head_short_circuits_zero_row_gemm(use_fp32_lm_head, expected_dtype):
